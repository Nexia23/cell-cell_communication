...
g_rate1=0.2                        #growthrate of radius
g_rateon=0.12
g_rate3=0.2
rangetox=0.4
...
def pice(a):  # creats vtu data with cell situation at time step
    ...
    vtk_writer.snapshot("cell_arrangements_eps" + str(a) + ".vtu", x_list, y_list, z_list, radii=r_list,
                        x_force=F_x,
                        y_force=F_y, z_force=F_z)
    vtk_writer.writePVD("cell_arrangements_eps" + str(a) + ".pvd")
